<?php
	...
	class JXP_Curl {
		...
		public static function withPost($post = [], $options = []) {
		...
		public static function withGet($get = []) {
		...
		public static function withOpt($opt = [], $value = null) {
