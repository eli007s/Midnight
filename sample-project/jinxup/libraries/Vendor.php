<?php
	...
	class JXP_Vendor {
		...
		public static function load($vendor = null) {

			$path = dirname(__DIR__) . DS . 'vendors' . DS;

            self::$_vendor[$vendor] = strtolower($vendor);
		...
		public static function get($vendor) {

		    return self::$_vendor[$vendor];
        }
